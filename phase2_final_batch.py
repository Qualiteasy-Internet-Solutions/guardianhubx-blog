#!/usr/bin/env python3
"""Add Phase 2 CTAs to remaining posts by appending to the end."""
...
base_dir = "content/es"
for filename, cta_data in ctas.items():
