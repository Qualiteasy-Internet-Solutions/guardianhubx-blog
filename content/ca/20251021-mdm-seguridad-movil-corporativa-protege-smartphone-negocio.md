...
-   **Apps malicioses o no oficials:** La descàrrega d'aplicacions fora de les botigues oficials (Google Play, App Store) obre la porta a virus, troians o _spyware_ que poden comprometre la seguretat.
-   **Phishing per SMS o missatgeria (Smishing):** Missatges fraudulents que simulen ser d'entitats legítimes (bancs, empreses de missatgeria, Hisenda) i busquen que l'usuari premi un enllaç o descarregui un arxiu maliciós. Aprèn a identificar un [atac de phishing aquí](https://guardianhubx.com/ca/formacio-phishing-software/).
...
👉 Vols protegir els dispositius mòbils de la teva empresa amb una estratègia sòlida? [Posa't en contacte amb nosaltres](https://guardianhubx.com/ca/contacte/) i t'ajudem a implementar les millors solucions.