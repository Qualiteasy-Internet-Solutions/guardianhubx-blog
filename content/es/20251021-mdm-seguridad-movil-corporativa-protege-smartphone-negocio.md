...
-   **Apps maliciosas o no oficiales:** La descarga de aplicaciones fuera de tiendas oficiales (Google Play, App Store) abre la puerta a virus, troyanos o _spyware_ que pueden comprometer la seguridad.
-   **Phishing por SMS o mensajería (Smishing):** Mensajes fraudulentos que simulan ser de entidades legítimas (bancos, empresas de mensajería, Hacienda) y buscan que el usuario pulse un enlace o descargue un archivo malicioso. Aprende a identificar un [ataque de phishing aquí](https://guardianhubx.com/es/formacion-phishing-software/).
...
>
> **[→ Obtén Evaluación de Seguridad Móvil (Gratis)](https://guardianhubx.com/es/#contact)** — Revisión experta de tu seguridad de endpoints.
